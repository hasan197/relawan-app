      ...
      <div className="mt-4 px-4">
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <QuickMenuItem
            ...
            label="Template"
            onClick={() =>
              handleQuickMenuClick("template-pesan")
            }
          />
          <QuickMenuItem
          ...
          <QuickMenuItem
            ...
            label="Follow Up"
            onClick={() =>
              handleQuickMenuClick("reminder-follow-up")
            }
          />
          <QuickMenuItem
            icon={<MessagesSquare className="h-5 w-5" />}
            label="Chat Regu"
            onClick={() => handleQuickMenuClick("chat-regu")}
          />
          <QuickMenuItem
            icon={<CalendarCheck className="h-5 w-5" />}
            label="Aktivitas"
            onClick={() =>
              handleQuickMenuClick("riwayat-aktivitas")
            }
          />
          <QuickMenuItem
            ...
            label="Materi"
            onClick={() =>
              handleQuickMenuClick("materi-promosi")
            }
          />
          {user?.role === "admin" && (
            <QuickMenuItem
      ...
      <div className="px-4 mb-6">
        ...
        <div className="space-y-3">
          {loading ? (
            ...
            statistics.recent_activities.length > 0 ? (
            statistics.recent_activities
              .slice(0, 5)
              .map((activity) => (
